...
@router.post('/v/Register_Student',  status_code=201)
...
@router.get('/v/Read_Student/{student_num}' , response_model= STU.Student_Info_Out , status_code=200)
...
@router.put('/v/Update_Student/{student_num}' , status_code=201)
...
@router.delete('/v/Delete_Student/{student_num}' , status_code=200)
