...
class Relation_table(Base):
    ...
    user_student_number = Column(VARCHAR,ForeignKey('student.user_student_number'))
    course_id = Column(VARCHAR,ForeignKey('course.course_id'))
    user_professor_id = Column(VARCHAR,ForeignKey('professor.user_professor_id'))
